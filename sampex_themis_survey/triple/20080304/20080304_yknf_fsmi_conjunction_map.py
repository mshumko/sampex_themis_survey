...
sampex_time_range = (datetime(2008, 3, 4, 5, 48, 0), datetime(2008, 3, 4, 5, 52, 0))
plot_time_range = (datetime(2008, 3, 4, 5, 49, 15), datetime(2008, 3, 4, 5, 50, 10))
...
themis_location_codes = ['FSMI']#, 'YKNF']
map_alt = 90
lon_bounds = (-122, -102)
lat_bounds = (56, 68)
color_bounds = None
